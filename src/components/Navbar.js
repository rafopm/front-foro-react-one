...
export default function Navbar() {
  ...
  const handleToggleNav = () => {
    setShowNav(!showNav); // Cambio de estado solo cuando se hace clic en el icono toggle
  };

  return (
    <div className={Styles.container}>
      <div className={Styles.toggle} onClick={handleToggleNav}>
        <Image src="/images/toggle.svg" width={24} height={16} alt="Logo Alura" />
      </div>
      {showNav && (
                ...
                <nav className={Styles.submenu}>
                  ...
                  <div className={Styles.submenuItemSalir}>
                    <Image
                      ...
                      alt="Icono salir"
                    />
                    <span style={{ marginLeft: "15px" }} onClick={handleLogout}>
                      SALIR
                    </span>
                  </div>
                </nav>
